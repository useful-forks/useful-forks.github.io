...
function setContent(li) {
  const content = `<div class="float-left">
                     <button id="${UF_BTN_ID}" class="btn-sm btn" aria-describedby="useful-forks-tooltip">
                     ...
                     <tool-tip for="useful_forks_btn" id="useful-forks-tooltip" data-direction="s" data-type="description" data-view-component="true" class="position-absolute sr-only" role="tooltip" style="left: 649.869px; top: 183px;">
