...
async function minify(options) {
  ...
  for (let i = 0; i < implementations.length; i++) {
    ...
    const currentInput = typeof lastCode === "string" || Buffer.isBuffer(lastCode) ? lastCode : input;
    const currentMap = typeof lastCode === "string" || Buffer.isBuffer(lastCode) ? lastMap : inputSourceMap;
    ...
    const currentOptions = /** @type {import("./index.js").MinimizerOptions<T>} */
    {
      ...
      module: typeof baseOptions.module === "undefined" ? module : baseOptions.module,
    ...
    if (typeof result.code === "string" || Buffer.isBuffer(result.code)) {
      ...
      lastMap = Buffer.isBuffer(result.code) ? undefined : composeSourceMaps(result.map, currentMap, name);
    }
  }
  return {
    code: lastCode,
